...
const Fetured = () => {
  ...
  <Image src={img} alt='f' width={800} height={300} className='rounded-2xl'></Image>    <div>
      <p className='bg-clip-text text-transparent bg-gradient-to-r from-[#ebf4f5] to-[#d3f3f1] '>Fetured Epidsode</p>
      <h1 className="text-5xl font-bold">Catalyst Conversations: Igniting Change through Insight</h1>
