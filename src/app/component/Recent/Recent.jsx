...
const Recent = () => {
    ...
    return (
        <div className='item-center flex flex-col  justify-center min-h-[50vh]  my-9 '>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3  gap-2 justify-center items-center mx-auto py-10 px-20'>
                {
                    episodes.map(p => (
<div className="card max-w-lg h-full bg-base-100 shadow-xl text-white " key={p.title} style={{backgroundImage:` linear-gradient(to right , #111111 0%, rgba(17, 17, 17, 0) 100%),url(${p.image})`, backgroundPosition:'center', backgroundSize:'cover', height:'100%',   }}>
